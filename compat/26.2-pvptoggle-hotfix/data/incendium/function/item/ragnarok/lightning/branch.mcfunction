...
execute positioned ^ ^ ^0.2 unless block ~ ~ ~ #incendium:airs if predicate incendium:random/other/x if predicate incendium:random/25 run particle minecraft:electric_spark ~ ~ ~ 0.2 0.35 0.2 0.08 20 force
...
execute if score #hit in.fire_laser matches 0 if score #distance2 in.fire_laser > $max_branch in.dummy positioned ^ ^ ^0.2 if predicate incendium:random/other/x if predicate incendium:random/0_001 run particle minecraft:electric_spark ~ ~ ~ 0.2 0.2 0.2 0.08 18 force
